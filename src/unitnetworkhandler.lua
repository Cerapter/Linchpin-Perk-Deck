...
function UnitNetworkHandler:sync_cohesion_stacks(data, affected, sender)
	...
	managers.player:set_synced_cohesion_stacks(peer_id, checked_cohesion_data, is_affected)
end